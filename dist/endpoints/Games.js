...
class GameApi {
     ...
     */
    search() {
        return __awaiter(this, arguments, void 0, function* (numEntries = 10, page = 0, lang = "en", filter = "", scenarioID = null) {
            const startTime = Date.now();
    ...
    getOverview(gameID) {
        return __awaiter(this, void 0, void 0, function* () {
            const startTime = Date.now();
            const properties = yield this.apiClient
                .sendRequest("getGames", { gameID })
                .then((result) => { var _a; return (_a = result.result[0]) === null || _a === void 0 ? void 0 : _a.properties; });
            ...
            const userDetails = yield Promise.all(Object.keys(finalDictionary).map((siteUserID) => this.apiClient.Users.getDetails(siteUserID)));
     ...
     */
    getAdvancedDetails(gameID_1) {
        return __awaiter(this, arguments, void 0, function* (gameID, stateID = 0, stateOption = null) {
            const startTime = Date.now();
    ...
    getAllNewspaper(gameID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const allNewspaper = yield Promise.all((Array.from({ length: lastDay + 1 }, (_, i) => i)).map((day) => this.getNewspaper(gameID, day).then((x) => {
                return x.result;
            })));
            const result = {
                resultCode: 0,
